...
public class SPELL {
	...
	int taille_nom;
	String nom = "";
	int taille_epuisement_mental;
	String epuisement_mental = "";	
	int taille_epuisement_physique;
	String epuisement_physique = "";
	int taille_epuisement_attaque;
	String epuisement_attaque = "";
	int taille_duree;
	String duree = "";
	int taille_frequence;
	String frequence = "";
	int element;
	int taille_cout_mana;
	String cout_mana = "";
	int rayon_degats;
	int index_gfx;
	int index_gfx_cible;
	...
	int index_icone;
	int taille_success_rate;
	String success_rate = "";
	int taille_description;
	String description = "";
	int nb_effets;
